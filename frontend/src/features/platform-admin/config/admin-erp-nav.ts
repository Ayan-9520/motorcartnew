...
export const ADMIN_ERP_NAV: AdminErpNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/dashboard/super-admin/revenue", label: "Billing & revenue", icon: BadgeIndianRupee },
      { to: "/dashboard/super-admin/payouts", label: "Payouts", icon: Landmark },
      { to: "/dashboard/super-admin/reward-rules", label: "Reward rules", icon: Sparkles },
