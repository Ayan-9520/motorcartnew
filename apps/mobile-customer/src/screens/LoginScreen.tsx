...
function makeStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    inner: { padding: 20, paddingTop: Platform.OS === "web" ? 48 : 36, paddingBottom: 36 },
    layout: { gap: 18 },
    layoutDesktop: { flexDirection: "row", alignItems: "stretch", gap: 28 },
    brandPane: { marginBottom: 4 },
    brandPaneDesktop: { flex: 1, justifyContent: "center", paddingRight: 12 },
    livePill: {
    ...
    formDesktop: { flex: 1, maxWidth: 440, alignSelf: "center" },
